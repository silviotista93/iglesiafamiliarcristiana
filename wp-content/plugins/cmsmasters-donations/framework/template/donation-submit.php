...
echo "<form action=\"{$action}\" method=\"post\" id=\"submit-donation-form\" class=\"cmsmasters_donations_form\" enctype=\"multipart/form-data\">
	<div class=\"cmsmasters_donation_fields\">
		<h2 class=\"cmsmasters_donation_form_title\">" . __('Detalles de donación', 'cmsmasters_donations') . "</h2>";
...
if (!empty($donator_fields)) {
	echo "<h2 class=\"cmsmasters_donation_form_title\">" . __('Detalles del donante', 'cmsmasters_donations') . "</h2>";
