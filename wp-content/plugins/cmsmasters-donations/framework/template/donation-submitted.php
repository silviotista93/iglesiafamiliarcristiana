...
case 'publish':
	echo '<div class="cmsmasters_notice cmsmasters_notice_success cmsmasters_donation_notice cmsmasters_donation_notice_success cmsmasters-icon-check">' . 
		...
		'<div class="notice_content">' . 
			wpautop(esc_html__('Donation validated successfully.', 'cmsmasters_donations')) . 
		'</div>' . 
	'</div>';
...
case 'pending_payment':
	echo '<div class="cmsmasters_notice cmsmasters_notice_success cmsmasters_donation_notice cmsmasters_donation_notice_success cmsmasters-icon-check">' . 
		...
		'<div class="notice_icon"></div>' . 
		'<div class="notice_content">' . 
			wpautop(esc_html__("Donation submitted successfully.\nYour donation will be published as soon as we receive the payment gateway validation (it can take several minutes).", 'cmsmasters_donations')) . 
		'</div>' . 
	'</div>';
...
case 'pending_offline' :
	echo '<div class="cmsmasters_notice cmsmasters_notice_success cmsmasters_donation_notice cmsmasters_donation_notice_success cmsmasters-icon-check">' . 
		...
		'<div class="notice_icon"></div>' . 
		'<div class="notice_content">' . 
			wpautop(esc_html__("Donation submitted successfully.\nYour donation will be published once payment is received.\nYou choose an offline payment method, so please follow the guide below to send us your payment.", 'cmsmasters_donations')) . 
		'</div>' . 
	'</div>';
...
echo '<a href="' . get_page_link(get_option('cmsmasters_donations_form_page')) . '" class="button">' . esc_html__('Make Another Donation', 'cmsmasters_donations') . '</a>';
