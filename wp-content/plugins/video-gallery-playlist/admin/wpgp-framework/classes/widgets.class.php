 ...
 *
 */
if( ! class_exists( 'WPGP_Widget' ) ) {
  class WPGP_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      $this->unique = $key;
      $this->args   = apply_filters( "wpgp_{$this->unique}_args", wp_parse_args( $params, $this->args ), $this );
      ...
      // Set filters
      $widget_ops  = apply_filters( "wpgp_{$this->unique}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "wpgp_{$this->unique}_control_ops", $control_ops, $this );
    ...
    public function form( $instance ) {
      ...
      if( ! empty( $this->args['fields'] ) ) {
        ...
        echo '<div class="wpgp wpgp-widgets wpgp-fields'. $class .'">';
        ...
        foreach( $this->args['fields'] as $field ) {
          ...
          WPGP::field( $field, $field_value, $field_unique );
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $new_instance = apply_filters( "wpgp_{$this->unique}_save", $new_instance, $this->args, $this );

      do_action( "wpgp_{$this->unique}_save_before", $new_instance, $this->args, $this );
