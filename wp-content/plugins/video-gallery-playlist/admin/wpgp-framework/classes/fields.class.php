...
if( ! class_exists( 'WPGP_Fields' ) ) {
  abstract class WPGP_Fields extends WPGP_Abstract {
    ...
    public function field_after() {
      ...
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<p class="wpgp-text-desc">'. $this->field['desc'] .'</p>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<span class="wpgp-help"><span class="wpgp-help-text">'. $this->field['help'] .'</span><span class="fa fa-question-circle"></span></span>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="wpgp-text-error">'. $this->field['_error'] .'</p>' : '';
