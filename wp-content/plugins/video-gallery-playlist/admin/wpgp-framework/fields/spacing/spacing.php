  ...
  class WPGP_Field_spacing extends WPGP_Fields {
    ...
    public function render() {
      ...
      if( ! empty( $args['all'] ) ) {
        ...
        echo '<input type="number" name="'. $this->field_name('[all]') .'" value="'. $value['all'] .'"'. $placeholder .' class="wpgp-input-number'. $is_unit .'" />';
        echo ( $unit ) ? '<span class="wpgp--label wpgp--unit">'. $args['units'][0] .'</span>' : '';
        echo '</div>';
        ...
        foreach( $properties as $property ) {
          ...
          echo '<input type="number" name="'. $this->field_name('['. $property .']') .'" value="'. $value[$property] .'"'. $placeholder .' class="wpgp-input-number'. $is_unit .'" />';
          echo ( $unit ) ? '<span class="wpgp--label wpgp--unit">'. $args['units'][0] .'</span>' : '';
          echo '</div>';
