  ...
  class WPGP_Field_select extends WPGP_Fields {
    ...
    public function render() {
      ...
      if( isset( $this->field['options'] ) ) {
        ...
        $field_class      = ( $args['chosen'] ) ? ' class="wpgp-chosen'. $chosen_rtl . $chosen_sortable . $chosen_ajax .'"' : '';
        ...
        if( ( is_array( $options ) && ! empty( $options ) ) || ( ! empty( $args['chosen'] ) && ! empty( $args['ajax'] ) ) ) {
          ...
          if( ! empty( $args['chosen'] ) && ! empty( $args['multiple'] ) ) {
            ...
            echo '<select name="'. $field_name .'" class="wpgp-hidden-select wpgp-hidden"'. $multiple_attr . $field_attr .'>';
