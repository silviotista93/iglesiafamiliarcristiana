 ...
 *
 */
if( ! class_exists( 'WPGP_Field_sortable' ) ) {
  class WPGP_Field_sortable extends WPGP_Fields {
    ...
    public function render() {
      ...
      foreach( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wpgp--sortable-item">';

          echo '<div class="wpgp--sortable-content">';
          ...
          WPGP::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wpgp--sortable-helper"><i class="fa fa-arrows"></i></div>';
