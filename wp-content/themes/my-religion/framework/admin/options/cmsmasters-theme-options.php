...
my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-general.php', true);
my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-post.php', true);
my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-page.php', true);
my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-other.php', true);


if (class_exists('Cmsmasters_Projects')) {
	my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-project.php', true);
}


if (class_exists('Cmsmasters_Profiles')) {
	my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-profile.php', true);
}


if (CMSMASTERS_TIMETABLE) {
	my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-tt-event.php', true);
}


if (CMSMASTERS_EVENTS_CALENDAR) {
	my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-tribe-event.php', true);
}


if (CMSMASTERS_DONATIONS) {
	my_religion_locate_template('cmsmasters-donations/admin/cmsmasters-theme-options-campaign.php', true);
	my_religion_locate_template('cmsmasters-donations/admin/cmsmasters-theme-options-donation.php', true);
}


if (class_exists('Cmsmasters_Sermons')) {
	my_religion_locate_template('cmsmasters-sermons/admin/cmsmasters-theme-options-sermon.php', true);
}

my_religion_locate_template(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-product.php', true);


if (!function_exists('my_religion_get_custom_all_meta_fields')) {
function my_religion_get_custom_all_meta_fields() {
	$custom_meta_fields = my_religion_get_custom_general_meta_fields();
	...
	if ( 
		...
		$custom_page_meta_fields = my_religion_get_custom_page_meta_fields();
		...
		$custom_project_meta_fields = my_religion_get_custom_project_meta_fields();
		...
		$custom_profile_meta_fields = my_religion_get_custom_profile_meta_fields();
		...
		$custom_tt_event_meta_fields = my_religion_get_custom_tt_event_meta_fields();
		...
		$custom_product_meta_fields = my_religion_get_custom_product_meta_fields();
		...
		$custom_campaign_meta_fields = my_religion_get_custom_campaign_meta_fields();
		...
		$custom_donation_meta_fields = my_religion_get_custom_donation_meta_fields();
		...
		$custom_tribe_event_meta_fields = my_religion_get_custom_tribe_event_meta_fields();
		...
		$custom_sermon_meta_fields = my_religion_get_custom_sermon_meta_fields();
		
		$custom_all_meta_fields = array_merge($custom_sermon_meta_fields, $custom_meta_fields);
	} elseif ( 
		...
		$custom_post_meta_fields = my_religion_get_custom_post_meta_fields();
		
		$custom_all_meta_fields = array_merge($custom_post_meta_fields, $custom_meta_fields);
	} else {
		$custom_other_meta_fields = my_religion_get_custom_other_meta_fields();
...
function my_religion_admin_enqueue_scripts($hook) {
	if ( 
		($hook == 'post.php') || 
		($hook == 'post-new.php') 
	) {
		...
		wp_localize_script('cmsmasters_theme_options_js', 'cmsmasters_options', array( 
			'create_gallery' => 	esc_attr__('Create Gallery', 'my-religion'), 
			'select_format' => 		esc_attr__('Please select the format.', 'my-religion'), 
			'link_exists' => 		esc_html__('Link with this format already exists.', 'my-religion'), 
			'want_remove' => 		esc_html__('Do you really want to remove this item?', 'my-religion'), 
...
add_action('admin_enqueue_scripts', 'my_religion_admin_enqueue_scripts');


function my_religion_show_meta_box() {
	global $post;
	
	$custom_all_meta_fields = my_religion_get_custom_all_meta_fields();
	...
	foreach ($custom_all_meta_fields as $field) {
		...
		case 'select_sidebar':
			...
			echo '<select name="' . $field['id'] . '" id="' . $field['id'] . '">' . 
				'<option value="">' . esc_html__('Default Sidebar', 'my-religion') . '</option>';
		...
		case 'select_slider':
			...
			echo '<select name="' . $field['id'] . '" id="' . $field['id'] . '">' . 
				'<option value="">' . esc_html__('Select Slider', 'my-religion') . '</option>';
		...
		case 'select_post_categ':
			...
			echo '<select name="' . $field['id'] . '" id="' . $field['id'] . '">' . 
				'<option value="">' . esc_html__('Select Blog Category', 'my-religion') . '</option>';
		...
		case 'select_project_cat':
			...
			echo '<select name="' . $field['id'] . '" id="' . $field['id'] . '">' . 
				'<option value="">' . esc_html__('Select Project Category', 'my-religion') . '</option>';
		...
		case 'select_pl_categ':
			...
			echo '<select name="' . $field['id'] . '" id="' . $field['id'] . '">' . 
				'<option value="">' . esc_html__('Select Profile Category', 'my-religion') . '</option>';
		...
		case 'image':
			...
			echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
				'<input type="button" id="cmsmasters_upload_' . $field['id'] . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'my-religion') . '" data-title="' . esc_attr__('Choose Image', 'my-religion') . '" data-button="' . esc_attr__('Insert Image', 'my-religion') . '" data-id="cmsmasters-media-select-frame-' . $field['id'] . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($field['description'])) ? ' cmsmasters-frame-no-description' : '') . ((!isset($field['caption'])) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($field['align'])) ? ' cmsmasters-frame-no-align' : '') . ((!isset($field['link'])) ? ' cmsmasters-frame-no-link' : '') . ((!isset($field['size'])) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $field['frame'] . '"' . (($field['frame'] === 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $field['multiple'] . '" />' . 
		...
		case 'icon':
			echo '<div class="icon_management">' . 
				'<p>' . 
					...
					'<input id="' . $field['id'] . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'my-religion') . '" />' . 
					'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Remove icon', 'my-religion') . '"' . (($meta != '') ? ' style="display:inline-block;"' : '') . '></a>' . 
				'</p>' . 
			'</div>' . 
		...
		case 'repeatable_link':
			...
			echo '<div class="ovh">' . 
				'<div class="fl"><strong>' . esc_html__('Title', 'my-religion') . '</strong></div>' . 
				'<div class="fl"><strong>' . esc_html__('Link', 'my-religion') . '</strong></div>' . 
			'</div>' . 
			...
			'<select name="' . $field['id'] . '-select" id="' . $field['id'] . '-select">' . 
				'<optgroup label="' . esc_attr__('Blank Field', 'my-religion') . '">' . 
					'<option value="">' . esc_html__('Select Link', 'my-religion') . '</option>' . 
				'</optgroup>' . 
				'<optgroup label="' . esc_attr__('Posts', 'my-religion') . '">';
			...
			echo '</optgroup>' . 
				'<optgroup label="' . esc_attr__('Pages', 'my-religion') . '">';
			...
			echo '</optgroup>' . 
				'<optgroup label="' . esc_attr__('Projects', 'my-religion') . '">';
		...
		case 'repeatable_multiple':
			echo '<div class="ovh">' . 
				'<div class="fl"><strong>' . esc_html__('Title', 'my-religion') . '</strong></div>' . 
				'<div class="fl"><strong>' . esc_html__('Values', 'my-religion') . '</strong></div>' . 
			'</div>' . 
			'<ul id="' . $field['id'] . '-repeatable" class="custom_repeatable">';
		...
		case 'repeatable_media':
			echo '<select name="' . $field['id'] . '-select" id="' . $field['id'] . '-select">' . 
				'<option value="">' . esc_html__('Select Format', 'my-religion') . ' &nbsp;</option>';
		...
		case 'images_list':
			...
			echo '<div class="cmsmasters_upload_parent cmsmasters_gallery_parent">' . 
				'<input type="button" id="cmsmasters_gallery_' . $field['id'] . '_button" class="cmsmasters_upload_button button button-large" value="' . (($meta != '') ? esc_attr__('Edit Gallery', 'my-religion') : esc_attr__('Create Gallery', 'my-religion')) . '" data-title="' . esc_attr__('Create/Edit Gallery', 'my-religion') . '" data-button="' . esc_attr__('Insert Gallery', 'my-religion') . '" data-id="cmsmasters-media-select-frame-' . $field['id'] . '" data-classes="media-frame cmsmasters-media-gallery-frame' . ((!isset($field['description'])) ? ' cmsmasters-frame-no-description' : '') . ((!isset($field['caption'])) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($field['align'])) ? ' cmsmasters-frame-no-align' : '') . ((!isset($field['link'])) ? ' cmsmasters-frame-no-link' : '') . ((!isset($field['size'])) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $field['frame'] . '"' . (($field['frame'] == 'post') ? ' data-state="' . (($meta != '') ? 'gallery-edit' : 'gallery-library') . '"' : '') . ' data-multiple="' . $field['multiple'] . '"' . (($meta != '') ? ' data-editing="true"' : '') . ' />' . 
				...
				foreach ($ids as $id) {
					if (isset($id[0]) && isset($id[1])) {
						echo '<li class="cmsmasters_gallery_item">' . 
							...
							'<a href="#" class="cmsmasters_gallery_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'my-religion') . '"></a>' . 
						'</li>';
					}
				}
			}
		...
		case 'funds':
			...
			echo '<div class="cmsmasters_funds_stats">' . 
				'<div class="cmsmasters_funds_stat_wrap">' . 
					...
					'</div>' . 
				'</div>' . 
				'<span class="fl">' . esc_html__('count', 'my-religion') . ' - <strong>' . $funds_number . '</strong></span>' . 
				'<span class="fr">' . cmsmasters_donations_currency(cmsmasters_number_format($target - $funds)) . ' ' . esc_html__('to go', 'my-religion') . '</span>';
			'</div>' . 
			(($field['desc'] != '') ? '<br />' . '<span class="description">' . $field['desc'] . '</span>': '');
...
function my_religion_save_custom_meta($post_id) {
    $custom_all_meta_fields = my_religion_get_custom_all_meta_fields();
...
add_action('save_post', 'my_religion_save_custom_meta');


function my_religion_add_custom_cmsmasters_meta_box() {
	$args = array(
	   'public' => true 
	);
	...
	foreach ($screens as $screen) {	
		add_meta_box( 
			...
			esc_html__('Theme Options', 'my-religion'), 
			'my_religion_show_meta_box', 
			$screen, 
			'normal', 
			'high' 
		);
...
add_action('add_meta_boxes', 'my_religion_add_custom_cmsmasters_meta_box');
