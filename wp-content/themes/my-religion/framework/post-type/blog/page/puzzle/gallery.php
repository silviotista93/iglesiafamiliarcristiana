	...
	<?php 
		if (!post_password_required()) {
			if (sizeof($cmsmasters_post_images) >= 1 && $cmsmasters_post_images[0] != '') {
				...
				my_religion_thumb(get_the_ID(), 'cmsmasters-project-thumb', false, 'img_' . get_the_ID(), true, false, true, true, $first_post_image, $unique_id);
				...
				my_religion_post_format_icon_placeholder(get_the_ID(), 'gallery');
			}
		} else {
			my_religion_post_format_icon_placeholder(get_the_ID(), 'gallery');
		}
